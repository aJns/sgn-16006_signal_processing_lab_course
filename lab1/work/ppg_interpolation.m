...
for i = 1+pad:imgSize(1)+pad
    for j = 1+pad:imgSize(2)+pad
        ...
        elseif ~mod(i,2) && ~mod(j,2)
            ...
            R(i-pad, j-pad) = hue_transit(inputG(2, 2), inputG(2, 3), inputG(2, 4), inputR(2, 2), inputR(2, 4));
            B(i-pad, j-pad) = hue_transit(inputG(1, 3), inputG(2, 3), inputG(3, 3), inputB(1, 3), inputB(3, 3));
        end
    end
end

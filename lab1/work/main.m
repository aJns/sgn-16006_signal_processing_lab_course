...
figure;
subplot(3, 3, 1); imshow(nnImage2(corner2:corner2+areaSize, corner2:corner2+areaSize, :));
subplot(3, 3, 2); imshow(blImage2(corner2:corner2+areaSize, corner2:corner2+areaSize, :));
subplot(3, 3, 3); imshow(ppgImage2(corner2:corner2+areaSize, corner2:corner2+areaSize, :));

subplot(3, 3, 4); imshow(nnImage5(corner5:corner5+areaSize, corner5:corner5+areaSize, :));
subplot(3, 3, 5); imshow(blImage5(corner5:corner5+areaSize, corner5:corner5+areaSize, :));
subplot(3, 3, 6); imshow(ppgImage5(corner5:corner5+areaSize, corner5:corner5+areaSize, :));

subplot(3, 3, 7); imshow(nnTestImage(cornerT:cornerT+areaSize, cornerT:cornerT+areaSize, :));
subplot(3, 3, 8); imshow(blTestImage(cornerT:cornerT+areaSize, cornerT:cornerT+areaSize, :));
subplot(3, 3, 9); imshow(ppgTestImage(cornerT:cornerT+areaSize, cornerT:cornerT+areaSize, :));
